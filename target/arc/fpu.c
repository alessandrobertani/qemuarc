...
/* Setup the build register value */
static void setup_fpu_build_reg(ARCCPU *cpu) {
    uint32_t reg_bld = 0;
    switch (cpu->family) {
        case ARC_OPCODE_ARCv2HS:
            reg_bld = (1 << 0)    |   /* version: ARCV2 HS FPU version 1 */
                    (1 << 8)    |   /* sp: single precision */
                    (1 << 9)    |   /* sf: sp fuse multiply add/sub */
                    (1 << 10)   |   /* sc: sp conversions */
                    (1 << 11)   |   /* sd: sp square-root and divide */
                    (1 << 16)   |   /* dp: double precision */
                    (1 << 17)   |   /* df: dp fused multiply add/sub */
                    (1 << 18)   |   /* dc: dp conversions */
                    (1 << 19)   |   /* dd: dp square-root and divide */
                    (0 << 20);      /* hp: half precision <-> sp conversion */
            break;

        case ARC_OPCODE_ARCv2EM:
            reg_bld = (3 << 0)    |   /* version: ARCV2 EM FPU version 2 */
                    (1 << 8)    |   /* sp: single precision */
                    (1 << 9)    |   /* sf: sp fuse multiply add/sub */
                    (1 << 10)   |   /* sc: sp conversions */
                    (1 << 11)   |   /* sd: sp square-root and divide */
                    (0 << 12)   |   /* fm: fast multiplication */
                    (0 << 13)   |   /* fd: fast divide and square root */
                    (0 << 14)   |   /* pi: unit pipeline implementation */
                    (1 << 24);      /* dp: double precision */
            break;
 ...
 * regs.c via the templates AUX_REG_SETTER and AUX_REG_GETTER, thus the unused
 * aux_reg_detail
 */

/* Retrieves the value from the auxiliary register fpu_status */
...
/* Sets the value from the auxiliary register fpu_status */
...
/* Retrieves the value from the auxiliary register fpu_ctrl */
...
/* Sets the value from the auxiliary register fpu_ctrl */
