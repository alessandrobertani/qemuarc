...
gdb_v3_fpu_read(CPUState *cs, GByteArray *mem_buf, int regnum)
{
    ...
    case V3_FPU_CTRL:
        return gdb_get_reg32(mem_buf,
                             arc_fpu_ctrl_get(NULL, env));
    case V3_FPU_STATUS:
        return gdb_get_reg32(mem_buf, arc_fpu_status_get(NULL, env));
    default:
        return 0;
    }
}
...
gdb_v3_fpu_write(CPUState *cs, uint8_t *mem_buf, int regnum)
{
    ...
    case V3_FPU_BUILD:
        ...
        return 0;
    case V3_FPU_CTRL:
        arc_fpu_ctrl_set(NULL, ldl_p(mem_buf), env);
        return sizeof(uint32_t);
    case V3_FPU_STATUS:
        arc_fpu_status_set(NULL, ldl_p(mem_buf), env);
        return sizeof(uint32_t);
    default:
        return 0;
    }
