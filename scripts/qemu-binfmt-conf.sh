...
microblaze microblazeel or1k x86_64 hexagon loongarch64 arc"
...
arc_magic='\x7fELF\x01\x01\x01\x00\x00\x00\x00\x00\x00\x00\x00\x00\x02\x00\xc3\x00'
arc_mask='\xff\xff\xff\xff\xff\xff\xff\x00\xff\xff\xff\xff\xff\xff\xff\xff\xfe\xff\xff\xff'
arc_family=arc
